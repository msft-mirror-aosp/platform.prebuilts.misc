...
monitorVersion="1.8.0-alpha01"
runnerVersion="1.7.0-alpha01"
rulesVersion="1.7.0-alpha01"
espressoVersion="3.7.0-alpha01"
coreVersion="1.7.0-alpha01"
extJUnitVersion="1.3.0-alpha01"
extTruthVersion="1.7.0-alpha01"
orchestratorVersion="1.6.0-alpha02"
servicesVersion="1.6.0-alpha02"
...
metadataTemplate = """
name: "{name}"
description: "A library for Android testing"
third_party {{
  url {{
    type: HOMEPAGE
    value: "https://github.com/android/android-test"
  }}
  url {{
    type: ARCHIVE
    value: "{archiveUrl}"
...
def downloadArtifact(groupId, artifactId, version):
   ...
   addMetadata(artifactDirPath, "https://dl.google.com/dl/android/maven2/%s-sources.jar" % artifactPath, version, artifactId)
...
def downloadApk(groupId, artifactId, version):
   ...
   addMetadata(artifactDirPath, "https://dl.google.com/dl/android/maven2/%s.apk" % artifactPath, version, artifactId)
...
def addMetadata(artifactDirPath, artifactUrl, version, name):
  metadataPath = os.path.join(artifactDirPath, "METADATA")
