my_robolectric_runtime_deps := \
    ...
    lib/pluginapi-4.3.jar \
    lib/plugins-maven-dependency-resolver-4.3.jar \
    lib/protobuf-java-2.6.1.jar \
    lib/resources-4.3.jar \
    lib/robolectric-4.3.jar \
    lib/sandbox-4.3.jar \
    lib/shadowapi-4.3.jar \
    lib/shadows-framework-4.3.jar \
    lib/shadows-httpclient-4.3.jar \
    lib/shadows-multidex-4.3.jar \
    lib/shadows-playservices-4.3.jar \
    lib/shadows-supportv4-4.3.jar \
    lib/sqlite4java-0.282.jar \
    lib/support-annotations-28.0.0.jar \
    lib/utils-4.3.jar \
    lib/utils-reflector-4.3.jar \
